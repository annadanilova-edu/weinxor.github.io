...
define("__TO__", "weinxor@gmail.com");

//Success message
define('__SUCCESS_MESSAGE__', "Ваше сообщение отправлено. Мы скоро ответим. Спасибо!");
...
if(isset($_POST['name']) and isset($_POST['emaild']) and isset($_POST['message'])){
    ...
    if($name == '') {
        ...
        echo json_encode(array('info' => 'error', 'msg' => "Пожалуйста, введите действительный адрес электронной почты."));
        exit();
    } else if($messageForm == ''){
